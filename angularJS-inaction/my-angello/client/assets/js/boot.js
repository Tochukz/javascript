head.load(
    { file: '//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.js' },
    { file: '//cdnjs.cloudflare.com/ajax/libs/angular.js/1.5.0-rc.0/angular.js' },
    { file: '//cdnjs.cloudflare.com/ajax/libs/angular.js/1.5.0-rc.0/angular-messages.js' },
    { file: '//cdnjs.cloudflare.com/ajax/libs/angular.js/1.5.0-rc.0/angular-route.js' },
    { file: '//cdnjs.cloudflare.com/ajax/libs/angular.js/1.5.0-rc.0/angular-animate.js' },
    { file: '//cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/js/bootstrap.js' },
    { file: '//cdnjs.cloudflare.com/ajax/libs/gsap/latest/TweenMax.min.js' },
    { file: '//cdn.firebase.com/js/client/2.3.2/firebase.js' },
    { file: '//cdn.firebase.com/libs/angularfire/1.1.3/angularfire.js' },
    { file: '//cdn.auth0.com/js/lock-7.js' },
